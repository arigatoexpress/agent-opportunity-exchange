...
export function buildDemoGuide(baseUrl = "") {
  ...
  return {
    ...
    videoFlow: [
      ...
      { label: "Opportunity public-program preview", method: "POST", path: "/v1/adapters/opportunities/public-programs/preview" },
    ...
    curlExamples: [
      ...
      `curl -fsS -X POST ${origin}/v1/adapters/opportunities/public-programs/preview -H 'content-type: application/json' -d '{"keyword":"wildfire resilience","limit":5}'`,
